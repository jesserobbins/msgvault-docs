...
<figure data-lightbox style="margin: 1.5rem 0; text-align: center;">
  <img src="/concepts/safety-ladder-concept.png" alt="The safety ladder: five rungs, 00 through 04. Rung 00 is an automatic backup; rungs 01 scan, 02 hide, 03 local hard delete, and 04 remote delete are deliberate, opt-in actions. Deletion is never required." loading="lazy" style="width: 100%; display: block;" />
</figure>
