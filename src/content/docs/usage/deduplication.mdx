...
<img src="/concepts/survivor-selection-concept.png" alt="Survivor selection runs the sent-copy eligibility filter first, then a priority list: source preference, raw MIME, richer labels, earlier archive time, and finally a stable row ID." style="width: 100%; max-width: 760px; margin: 1.5rem auto; display: block;" />
